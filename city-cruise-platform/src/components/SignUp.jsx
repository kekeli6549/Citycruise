            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-[10px] text-slate-500 leading-relaxed">
                  I agree to the <a href="#" className="text-brand-blue underline">Terms of Excellence</a> and the <a href="#" className="text-brand-blue underline">Global Privacy Policy</a>.
                </p>
              </div>

              <button type="submit" className="w-full bg-brand-dark dark:bg-brand-blue text-white py-5 rounded-2xl font-bold uppercase text-[11px] tracking-[0.3em] shadow-2xl hover:bg-black transition-all flex items-center justify-center gap-2">
                Begin Journey <ArrowRight size={14} />
              </button>
            </form>

            <p className="mt-10 text-center text-[11px] text-slate-500 font-body">
              Already have an account? <Link to="/login" className="text-brand-blue font-bold">Sign In</Link>
            </p>
          </div>
        </div>
      </div>
